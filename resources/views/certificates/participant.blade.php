...
<html lang="pt-br">
    ...
    <body>
       <div class="background">
            <div class="texto">
            <p>Certificamos que {{ $name }}, portador(a) do CPF de Nº {{ $cpf }} participou com êxito da {{ $typeevent }} intitulado(a) <strong>"{{ $subevent }}"</strong> realizado(a) na <strong>{{ $event }}</strong> de {{ $dataevent }}.</p>
            <br />
            <br />
