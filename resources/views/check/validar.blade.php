                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 text-center mt-5">
                            ...
                            <p>Para consultar certificados insira o códico de validação abaixo:</p>
                            <form action="/resultado" method="post">
                                @csrf
                                <div>
                                    <input type="text" placeholder="Digite o código de validacao" name="cod"  id='cod' class="inputs required">
